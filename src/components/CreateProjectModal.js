...
const CreateProjectModal = () => {
  ...
  const handleAddCategoryField = () => {
    setCategoryFields([...categoryFields, { category: "", subCategory: "" }])
  }
              ...
              {categoryFields.map((field, idx) => (
                <div key={idx} className="mb-2">
                  ...
                  <p>
                    ...
                    <span className='ml-1'>{field.subCategory}</span>
                  </p>
                </div>
              ))}
            </div>
            ...
            {currentStep < steps.length - 1 && (
              ...
              >
                {currentStep > 0 && (
                  <button
                    onClick={handleBack}
                    className='bg-gray-500 dark:text-white px-4 py-[0.35rem] rounded hover:bg-gray-600'
                  >
                    Previous
                  </button>
                )}
